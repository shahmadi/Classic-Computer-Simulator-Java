...
transfer instructions test the value of a register. Note R = 0ï¿½3. They have 
...
public class Transfer {
	...
	public static void instructionJNE(Instruction instruction) throws Throwable{
		...
		//implementing JSR
		public static Integer instructionJSR(Instruction instruction) throws Throwable{
			...
			/*Jump and Save Return Address:
				...
				Argument list should end with ï¿½17777 value*/
		...
		public static void instructionRFS(Instruction instruction) throws Throwable{
			...
			/*Return From Subroutine w/ return code as Immed portion (optional) stored in the instructionï¿½s address field. 
					R0 <- Immed; PC <-- c(R3)
