...
public class MemoryPanel extends JPanel{
	...
	private JScrollPane memoryScrollPanel;//define a jSrollpane method 
	...
	public MemoryPanel(int memorySize, JTextPane[] memory) {
		...
		memoryScrollPanel = new JScrollPane();// arrange a ScrollPane for memoryScrollpanel
		...
		for(int i = 0; i < memorySize; i++){
			...
			JLabel label = new JLabel("" + i);// show memory's label one by one
